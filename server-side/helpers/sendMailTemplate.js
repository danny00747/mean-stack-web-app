const mailTemplate = '<!DOCTYPE html>\n' +
    ...
    '                                        <a href="https://devwebapp.herokuapp.com" target="_blank">\n' +
    '                                            <img width="20" height="30" alt="logo"\n' +
    '                                                 src="https://raw.githubusercontent.com/danny00747/mean-stack-web-app/master/server-side/public/dist/favicon.ico"></a>\n' +
    '                                    </td>\n' +
    ...
    '                                            Verify your e-mail to finish signing up for devwebapp.herokuapp.com</p>\n' +
    '                                    </td>\n' +
    '                                </tr>\n' +
    '                                <tr>\n' +
    '                                    <td height="20"></td>\n' +
    ...
    '                                            Thank you for choosing our website.</p>\n' +
    ...
    '                                                href="https://devwebapp.herokuapp.com"\n' +
    ...
    '                                        <p style="margin: 0;color: #585858;font-size: 12px;font-weight: 400;-webkit-font-smoothing:antialiased;line-height: 170%;">\n' +
    '                                            Teacher App, Inc.<br> 330 East 59th Street, 7th Floor<br> New York, NY 10022,\n' +
    '                                            USA</p>\n' +
    '                                    </td>\n' +
    '                                </tr>\n' +
    '                                </td>\n' +

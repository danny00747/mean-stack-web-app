...
import {addUserService, editUserService, logInUserService} from '../../../services/users'
...
describe('USER SERVICE', () => {
    ...
    describe('#edit-user', () => {
        ...
        it("must include an id", async () => {
            const editUser = await editUserService({id: undefined, ...makeFakeUser()});
        ...
        it("must have valid id", async () => {
            const editUser = await editUserService({id: "123", ...makeFakeUser()});
            expect(editUser.message)
        ...
        it("can edit user", async () => {
            ...
            const editUser = await editUserService({id: env.ADMIN_ID, ...userToEdit});

...
describe('E2E TESTS FOR ADMIN PAGES', async () => {
  ...
  describe('/GET Users', () => {
    ...
    it("it should create a fill in the blanks question", async () => {
      ...
      await fillInQuestion.type('Albert Einstein {be}[was] born in Germany, ' + 'on March 14, 1879. Six weeks later his family {move}[moved] to Munich, ' + 'where he later on {begin}[began] his schooling at the Luitpold Gymnasium.');

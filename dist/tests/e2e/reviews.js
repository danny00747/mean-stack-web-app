...
describe('E2E TESTS FOR REVIEWS PAGE', async () => {
  ...
  describe('/GET Reviews', () => {
    it('it should display all reviews', async () => {
      ...
      expect((await page.$eval('#comments', e => e.innerText)).includes('comments')).to.eql(true);
  ...
  describe('/POST Review', () => {
    it('it should create a review', async () => {
      ...
      await page.waitFor(1000);
      expect(await page.$eval('#createSuccess', el => el.innerText)).eql('Review created successfully !');
      await page.waitFor(1000);
    ...
    it('it should update a review', async () => {
      ...
      await reviewSubmit.click();
      await page.waitFor(1000);
      expect(await page.$eval('#createSuccess', el => el.innerText)).eql('Review updated successfully !');
      await page.waitFor(1000);
      await page.click('[id="modalClose"]');
      await page.waitFor(2000);
    });
    it('it should delete a review', async () => {
      expect(page.url()).eql('http://localhost:4200/reviews'); //await page.reload();
      ...
      await page.waitFor(1000);
      expect(await page.$eval('#reviewdeleteAlert', el => el.innerText)).eql('Review deleted successfully !');
      await page.waitFor(1000);

...
exports.default = makeQuestionRepository;

function makeQuestionRepository({
  Question
}) {
  ...
  async function findAll() {
    return await Question.find().select("question answers _id type").exec();
  }
  ...
  async function findById({
    ...
    return await Question.findById({
      _id
    }).select("question answers _id").exec();
  }
